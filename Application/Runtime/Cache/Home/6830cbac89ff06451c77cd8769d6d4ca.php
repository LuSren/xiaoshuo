...
<link rel="stylesheet"href="./Application/Home/Include/style/font-awesome.min.css">
...
<div class="naviBar">
<ul class="head-nav">
<a href="#" rel="external"><li>小说系统</li></a>
</ul>
</div>
</div> 
...
<ul class="nav-list">
<a href="#" rel="external" title="小说" ><li>小说</li></a>
</ul> 
</div>
</div>
</div>
		...
		<li class="aui-list-item aui-list-item-middle">
            <div class="aui-media-list-item-inner">
                <div class="aui-list-item-media" style="width: 3rem;">
                    <img src="./Application/Home/Include/images/tx.jpg" class="aui-img-round aui-list-img-sm">
                </div>
                <div class="aui-list-item-text">
                    <div class="aui-list-item-title aui-font-size-14">王花花</div>
                    <div class="aui-list-item-right">
                        <div class="aui-label aui-label-danger aui-label-outlined">会员</div>
                    </div>
                </div>
            </div>
        </li>
