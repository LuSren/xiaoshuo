...
<title>小说展示系统</title>
<meta name="keywords" content="小说展示系统">
<meta name="description" content="小说展示系统">
...
<span id="index"><i class="ico07"><img src="./Application/Home/Include/images/logo.png" width="88px" class="h"/></i></span><i class="ico21">小说展示系统</i>
<span id="find"><i class="ico08"><img src="./Application/Home/Include/images/ss1.png" width="29px" /></i></span>
</div>
<div class="m-nav-head">
<div class="naviBar">
<ul class="head-nav">
<?php if(is_array($ftype)): $i = 0; $__LIST__ = $ftype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/book_type','type='.$vo['id']);?>"><li><?php echo ($vo["type_name"]); ?></li></a><?php endforeach; endif; else: echo "" ;endif; ?>
</ul>
</div>
</div> 
...
<ul class="nav-list">
<?php if(is_array($ftype)): $i = 0; $__LIST__ = $ftype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php echo U('Index/book_type','type='.$vo['id']);?>" rel="external" title="<?php echo ($vo['type_name']); ?>"><li><?php echo ($vo["type_name"]); ?></li></a><?php endforeach; endif; else: echo "" ;endif; ?>
</ul> 
</div>
</div>
</div>
...
<?php if(is_array($list)): $i = 0; $__LIST__ = array_slice($list,1,10,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="aui-list aui-list-in">
	<li class="aui-list-item aui-col-xs-12" onclick="window.location.href='<?php echo U('Index/book','id='.$vo['id']);?>'">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-title">
                	<span class="aui-pull-left" style="color:#d64f4f">[<?php echo ($ftype[$vo['type']-1]['type_name']); ?>]</span>
                	<span class="aui-content-padded"><?php echo ($vo["title"]); ?></span>
					<!-- <?php if($vo["member"] == 1): ?><div class="aui-label aui-label-danger aui-label-outlined">会员</div>
						<?php else: endif; ?> -->
                	<div class="aui-list-item-right"><?php echo (to_date($vo["time"],"m月d日")); ?></div>
                </div>
            </div>
        </li>
