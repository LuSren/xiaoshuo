...
<ul class="aui-list aui-list-in">
	...
	<?php if(is_array($kk)): $i = 0; $__LIST__ = $kk;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><img src="<?php echo ($vo); ?>" alt=""><br/><?php endforeach; endif; else: echo "" ;endif; ?>
    </div>
</ul>
<br/>
<p><div class="aui-btn aui-btn-warning aui-btn-block aui-btn-sm" onclick="window.location.href='<?php echo U('Img/num','id='.$list['id']);?>'">下一组</div></p>
