...
<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><ul class="aui-list aui-list-in">
	<li class="aui-list-item aui-col-xs-12" onclick="window.location.href='<?php echo U('Index/book','id='.$vo['id']);?>'">
            <div class="aui-list-item-inner">
                <div class="aui-list-item-title">
                	<span class="aui-pull-left" style="color:#d64f4f">[<?php echo ($nav["type_name"]); ?>]</span>
